...
public class KeyboardViewController: UIViewController {
    ...
    public override func loadView() {
        ...
        phoenixNumberButton.titleLabel?.font = UIFont(name: "Chalkboard SE", size: 18)
        ...
        phoenixNumberButton.setTitleColor(UIColor(red: 41.0/255, green: 8.0/255, blue: 149.0/255, alpha: 1.0), for: .normal)
        ...
        onesMultiplicationButton.titleLabel?.font = UIFont(name: "Chalkboard SE", size: 18)
        ...
        onesMultiplicationButton.setTitleColor(UIColor(red: 41.0/255, green: 8.0/255, blue: 149.0/255, alpha: 1.0), for: .normal)
